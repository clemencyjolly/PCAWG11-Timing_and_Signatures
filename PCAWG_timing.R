...
# clustering files
dpoutput_path = "/srv/shared/vanloo/ICGC-consensus-clustering/WM-final"
...
purity_ploidy = read.table("/srv/shared/vanloo/ICGC-CNA/CNA/consensus.20170217.purity.ploidy.txt.gz", header = TRUE)
sample_purity = subset(purity_ploidy, samplename == id)$purity
norm_cont = 1 - sample_purity

# copy number files
cn_path = "/srv/shared/vanloo/ICGC-CNA/CNA"
