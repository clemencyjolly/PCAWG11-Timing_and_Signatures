...
formatSNVs <- function(vcf){
  ...
  ref=FaFile("/srv/shared/vanloo/pipeline-files/human/references/alignment/hg19/ucsc.hg19.fasta")
...
formatMNVs <- function(vcf){
  ...
  t = read.delim(gzfile(paste0("/srv/shared/vanloo/ICGC-consensus-clustering/WM-final/", id, "_mutation_timing.txt.gz")), 
...
getSNVs_MNVs_IDs <- function(id){
  ...
  if (file.exists(paste0("/srv/shared/vanloo/ICGC_snv_mnv/final_consensus_12oct_passonly/snv_mnv/", id,
                         ".consensus.20160830.somatic.snv_mnv.vcf.gz"))){
    vcf = readVcfAsVRanges(paste0("/srv/shared/vanloo/ICGC_snv_mnv/final_consensus_12oct_passonly/snv_mnv/", id,
                                  ".consensus.20160830.somatic.snv_mnv.vcf.gz"), "hg19", param = ScanVcfParam(fixed=c("ALT","FILTER"),geno=NA))
  } else if (file.exists(paste0("/srv/shared/vanloo/ICGC_snv_mnv/final_consensus_12oct_passonly/graylist/snv_mnv/", id,
                                ".consensus.20160830.somatic.snv_mnv.vcf.gz"))){
    vcf = readVcfAsVRanges(paste0("/srv/shared/vanloo/ICGC_snv_mnv/final_consensus_12oct_passonly/graylist/snv_mnv/", id,
                                  ".consensus.20160830.somatic.snv_mnv.vcf.gz"), "hg19", param = ScanVcfParam(fixed=c("ALT","FILTER"),geno=NA))
  }
  ...
  # Indels
  if (file.exists(paste0("/srv/shared/vanloo/ICGC_snv_mnv/final_consensus_12oct_passonly/indel/", id,
                         ".consensus.20161006.somatic.indel.vcf.gz"))){
    indel_vcf = readVcfAsVRanges(paste0("/srv/shared/vanloo/ICGC_snv_mnv/final_consensus_12oct_passonly/indel/", id,
                                  ".consensus.20161006.somatic.indel.vcf.gz"), "hg19", param = ScanVcfParam(fixed=c("ALT","FILTER"),geno=NA))
  } else if (file.exists(paste0("/srv/shared/vanloo/ICGC_snv_mnv/final_consensus_12oct_passonly/graylist/indel/", id,
                                ".consensus.20161006.somatic.indel.vcf.gz"))){
    indel_vcf = readVcfAsVRanges(paste0("/srv/shared/vanloo/ICGC_snv_mnv/final_consensus_12oct_passonly/graylist/indel/", id,
                                  ".consensus.20161006.somatic.indel.vcf.gz"), "hg19", param = ScanVcfParam(fixed=c("ALT","FILTER"),geno=NA))
  }
...
# Read in signatures
snv_comp = read.csv("/srv/shared/vanloo/ICGC_signatures/20180322_release/sigProfiler_SBS_signatures.csv")
mnv_comp = read.csv("/srv/shared/vanloo/ICGC_signatures/20180322_release/sigProfiler_DBS_signatures.csv")
...
h = read.delim("/srv/shared/vanloo/home/khaase/ICGC/annotation/histology_specimen_August_v3.WGSaliquot.tsv")
snv_samples = read.csv("/srv/shared/vanloo/ICGC_signatures/20180322_release/PCAWG_sigProfiler_SBS_signatures_in_samples_waliqID.csv")
mnv_samples = read.csv("/srv/shared/vanloo/ICGC_signatures/20180322_release/PCAWG_sigProfiler_DBS_signatures_in_samples.csv")
...
id_comp = read.csv("/srv/shared/vanloo/ICGC_signatures/20180322_release/PCAWG_sigProfiler_ID_signatures_in_samples.csv")
...
timed_muts = read.delim(gzfile(paste0("/srv/shared/vanloo/ICGC-consensus-clustering/WM-final/", id, "_mutation_timing.txt.gz")), 
                        header=TRUE, stringsAsFactors = FALSE)
